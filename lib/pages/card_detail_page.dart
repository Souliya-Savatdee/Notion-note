...
class _CardDetailPageState extends State<CardDetailPage> {
  ...
  Future<void> editData(int id, String newTitle, String newDescription,
      String remind, String newModDate, String newPriority) async {
    try {
      final apiUrl = 'https://sheetdb.io/api/v1/6hf12ouxt0fmx/id/$id';
      final response = await http.put(
        Uri.parse(apiUrl),
    ...
    return AppBar(
      ...
      actions: [
        ...
        IconButton(
          onPressed: () {
            setState(() {
              _remind = (_remind == "TRUE") ? "FALSE" : "TRUE";
            });
          },
          icon: Icon(
            _remind == "TRUE"
